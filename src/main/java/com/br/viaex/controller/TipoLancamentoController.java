...
public class TipoLancamentoController {
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "201", description = "Criado (Created)", content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = TipoLancamentoDTO.class))}),
    ...
    public ResponseEntity<Object> cadastrar(@RequestBody TipoLancamentoDTO objeto) throws Exception {
        return tipoLancamentoService.cadastrar(objeto);
    }
    ...
    public ResponseEntity<Object> listar() throws Exception {
        return tipoLancamentoService.listar();
    }
    ...
    public ResponseEntity<Object> listarPorId(@PathVariable Long idObjeto) throws Exception {
        return tipoLancamentoService.listarPorId(idObjeto);
    }
    ...
    public ResponseEntity<Object> editar(@PathVariable Long idObjeto, @RequestBody TipoLancamentoDTO objeto) throws Exception {
        return tipoLancamentoService.editar(idObjeto, objeto);
    }
    ...
    public ResponseEntity<Object> excluir(@PathVariable Long idObjeto) throws Exception {
        return tipoLancamentoService.excluir(idObjeto);
    }
    ...
    public ResponseEntity<Object> mudarStatus(@PathVariable Long idObjeto) throws Exception {
        return tipoLancamentoService.mudarStatus(idObjeto);
    }
}
